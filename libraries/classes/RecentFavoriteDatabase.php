...
/**
 * Recent and Favorite database list handling
 *
 * @package PhpMyAdmin
 */
...
/**
 * Handles the recently used and favorite databases.
 *
 * 
 *
 * @package PhpMyAdmin
 */
class RecentFavoriteDb
{
    /**
     * Reference to session variable containing recently used or favorite databases.
     *
     * @access private
     * @var array
     */
    ...
    /**
     * Defines type of action, Favorite or Recent database.
     *
     * @access private
     * @var string
     */
    ...
    /**
     * RecentFavoriteDatabase instances.
     *
     * @access private
     * @var array
     */
